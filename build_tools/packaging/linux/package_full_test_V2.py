...
"""
Full installation test script for ROCm native packages (V2).
...
class PackageFullTesterV2:
    """Full installation tester for ROCm packages (V2 - supports nightly and prerelease)."""
    ...
    def construct_repo_url_with_os(self) -> str:
        """Construct the full repository URL including OS profile.
...
"""
    ...
    def run(self) -> bool:
        ...
        """
        print("\n" + "=" * 80)
        print("FULL INSTALLATION TEST - NATIVE LINUX PACKAGES (V2)")
        print("=" * 80)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Full installation test for ROCm native packages (V2 - supports nightly and prerelease)",
